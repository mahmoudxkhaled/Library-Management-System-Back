...
public class LMSDbContext : IdentityDbContext<User, IdentityRole<int>, int>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Book>().HasData(
                new Book { Id = 1, Title = "The Great Gatsby", ImageUrl = "Uploads/Books/240a09b8-7452-4cda-99e4-48627bfc2ba6_20250330_001414.jpeg", AuthorId = 1, Description = "Set in the Roaring Twenties, 'The Great Gatsby' follows the enigmatic millionaire Jay Gatsby as he pursues his love for Daisy Buchanan. Through the eyes of Nick Carraway, the novel explores themes of wealth, illusion, and the American dream, painting a vivid portrait of a society obsessed with status, longing, and the pursuit of happiness.", PublicationYear = 1925, AvailableCopies = 10, TotalCopies = 15, CategoryId = 1 },
                new Book { Id = 2, Title = "To Kill a Mockingbird", ImageUrl = "Uploads/Books/bbc43e3c-beff-4517-a107-e3ad3b7c3fbb_20250330_002428.png", AuthorId = 2, Description = "Set in the racially charged Deep South of the 1930s, this classic novel follows Scout Finch and her brother Jem as their father, Atticus, defends a black man falsely accused of a crime. Through the children's eyes, the story explores themes of justice, morality, and the loss of innocence in a divided society.", PublicationYear = 1960, AvailableCopies = 8, TotalCopies = 12, CategoryId = 1 },
                new Book { Id = 3, Title = "Sapiens: A Brief History of Humankind", ImageUrl = "Uploads/Books/ec03a3c1-b718-407b-9465-f8e867353021_20250330_000242.jpeg", AuthorId = 3, Description = "Yuval Noah Harari's 'Sapiens' takes readers on a sweeping journey through the history of humanity, from the emergence of Homo sapiens in Africa to the present day. The book examines how biology, culture, and economics have shaped our species, offering thought-provoking insights into what it means to be human.", PublicationYear = 2011, AvailableCopies = 12, TotalCopies = 20, CategoryId = 2 },
                new Book { Id = 4, Title = "Educated", ImageUrl = "Uploads/Books/0ff5c317-7915-4ee3-954f-4ebd7608d428_20250329_235320.jpeg", AuthorId = 4, Description = "'Educated' is the remarkable memoir of Tara Westover, who grew up in a strict and isolated survivalist family in rural Idaho. Denied formal education, she eventually escapes her upbringing and pursues learning, ultimately earning a PhD from Cambridge. Her story is one of resilience, transformation, and the power of education to change lives.", PublicationYear = 2018, AvailableCopies = 5, TotalCopies = 7, CategoryId = 3 },
                new Book { Id = 5, Title = "A Brief History of Time", ImageUrl = "Uploads/Books/2f7ebca3-e6c4-4c0b-aeac-ff396a023c49_20250329_234906.jpeg", AuthorId = 5, Description = "Stephen Hawking's groundbreaking work explores the origins, structure, and fate of the universe. Written for a general audience, the book delves into concepts like black holes, the Big Bang, and the nature of time itself, making complex scientific ideas accessible and inspiring curiosity about the cosmos.", PublicationYear = 1988, AvailableCopies = 15, TotalCopies = 25, CategoryId = 4 },
                new Book { Id = 6, Title = "The Selfish Gene", ImageUrl = "Uploads/Books/1ecaf167-5c32-4f68-8c43-57b97dec2a3e_20250330_002042.jpeg", AuthorId = 6, Description = "Richard Dawkins' influential book revolutionized the way we think about evolution. Focusing on the gene as the central unit of selection, Dawkins explains how natural selection operates at the genetic level, shaping behavior and life itself. The book is both a scientific treatise and a compelling narrative about the nature of life.", PublicationYear = 1976, AvailableCopies = 8, TotalCopies = 12, CategoryId = 2 },
                new Book { Id = 7, Title = "The Joy of x", ImageUrl = "Uploads/Books/eaeefb94-29ae-486b-baba-078d7ca17429_20250330_001647.jpeg", AuthorId = 7, Description = "Steven Strogatz's 'The Joy of x' brings the beauty and wonder of mathematics to life. Through engaging stories and real-world examples, the book reveals how math shapes our everyday experiences, from the patterns in nature to the logic behind technology, making complex concepts accessible and enjoyable for all readers.", PublicationYear = 2014, AvailableCopies = 6, TotalCopies = 9, CategoryId = 4 },
                new Book { Id = 8, Title = "Flatland: A Romance of Many Dimensions", ImageUrl = "Uploads/Books/e8b354e3-7ce0-4824-a92d-6cd434ef30cb_20250329_235623.jpeg", AuthorId = 8, Description = "Edwin A. Abbott's novella explores the nature of dimensions through the story of a two-dimensional world inhabited by geometric shapes. As the protagonist discovers the existence of a third dimension, the book offers a satirical commentary on Victorian society and challenges readers to expand their perspectives on reality.", PublicationYear = 1884, AvailableCopies = 7, TotalCopies = 10, CategoryId = 5 },
                new Book { Id = 9, Title = "The Diary of a Young Girl", ImageUrl = "Uploads/Books/169f079a-cfff-4d87-8f84-5a873a895504_20250330_001103.jpeg", AuthorId = 9, Description = "Anne Frank's diary chronicles her life in hiding during the Nazi occupation of the Netherlands. Through her candid and poignant entries, Anne offers a powerful account of hope, fear, and resilience in the face of unimaginable adversity, leaving a lasting legacy as a testament to the human spirit.", PublicationYear = 1947, AvailableCopies = 5, TotalCopies = 8, CategoryId = 6 },
                new Book { Id = 10, Title = "The Silk Roads", ImageUrl = "Uploads/Books/c508f639-13fb-425e-8e56-508c3fc2ba6b_20250330_002117.jpeg", AuthorId = 10, Description = "Peter Frankopan's 'The Silk Roads' reimagines world history from the perspective of the ancient trade routes that connected East and West. The book explores the cultural, economic, and political exchanges that shaped civilizations, offering a fresh and expansive view of the forces that have defined our world.", PublicationYear = 2015, AvailableCopies = 12, TotalCopies = 18, CategoryId = 2 },
                new Book { Id = 11, Title = "Steve Jobs", ImageUrl = "Uploads/Books/b5d07a17-b507-4aca-ae02-67407a95e307_20250330_000437.jpeg", AuthorId = 11, Description = "Walter Isaacson's biography of Steve Jobs offers an intimate look at the life and mind of Apple's visionary co-founder. Drawing on exclusive interviews, the book explores Jobs's relentless drive for innovation, his complex personality, and the creative process behind iconic products like the iPhone and Mac. It's a compelling portrait of genius, ambition, and the price of success.", PublicationYear = 2011, AvailableCopies = 10, TotalCopies = 15, CategoryId = 7 },
                new Book { Id = 12, Title = "The Autobiography of Malcolm X", ImageUrl = "Uploads/Books/5fd61fc7-4a57-4cec-bc1e-153df1b8d08b_20250330_000750.jpeg", AuthorId = 12, Description = "Told to journalist Alex Haley, this powerful autobiography traces Malcolm X's journey from a troubled youth to a prominent civil rights leader. The book explores his transformation through faith, his fight for justice, and his evolving views on race and society. It's a story of resilience, self-discovery, and the enduring struggle for equality.", PublicationYear = 1965, AvailableCopies = 8, TotalCopies = 12, CategoryId = 6 },
                new Book { Id = 13, Title = "Moby-Dick", ImageUrl = "Uploads/Books/7186fad6-481e-4b35-8730-bb5b38fe44d0_20250330_000006.jpeg", AuthorId = 13, Description = "Herman Melville's classic novel about the obsessive quest to capture the white whale, Moby-Dick. Through Ishmael's narration, the story delves into themes of obsession, fate, and the struggle between man and nature. Rich in symbolism and philosophical insight, it remains a towering achievement in American literature.", PublicationYear = 1851, AvailableCopies = 6, TotalCopies = 10, CategoryId = 1 },
                new Book { Id = 14, Title = "Pride and Prejudice", ImageUrl = "Uploads/Books/5b2c0142-74e5-4317-a9fb-dacaa00f2610_20250330_000111.jpeg", AuthorId = 14, Description = "Jane Austen's beloved novel is a witty and romantic exploration of manners, marriage, and social class in Regency England. The story follows Elizabeth Bennet as she navigates misunderstandings and prejudices, ultimately finding love with the enigmatic Mr. Darcy. It's a timeless tale of character, pride, and the transformative power of love.", PublicationYear = 1813, AvailableCopies = 10, TotalCopies = 14, CategoryId = 1 },
                new Book { Id = 15, Title = "Meditations", AuthorId = 15, Description = "Written by Roman Emperor Marcus Aurelius, 'Meditations' is a collection of personal reflections on Stoic philosophy, leadership, and the human condition. The book offers timeless wisdom on resilience, virtue, and self-mastery, providing readers with practical guidance for living a meaningful and ethical life in the face of adversity.", PublicationYear = 180, AvailableCopies = 7, TotalCopies = 10, CategoryId = 4 },
                new Book { Id = 16, Title = "The Republic", AuthorId = 16, Description = "Plato's philosophical masterpiece presents a dialogue on justice, the ideal state, and the nature of the soul. Through Socratic questioning, the book explores the meaning of virtue, the structure of society, and the pursuit of truth. It remains a foundational text in Western philosophy and political thought.", PublicationYear = -380, AvailableCopies = 8, TotalCopies = 11, CategoryId = 5 },
                new Book { Id = 17, Title = "Thinking, Fast and Slow", ImageUrl = "Uploads/Books/ddfb6c14-a1f1-4685-a835-16afd6354aac_20250330_002323.jpeg", AuthorId = 17, Description = "Nobel laureate Daniel Kahneman explores the dual systems that drive human thought: the fast, intuitive mind and the slow, deliberate mind. Through engaging examples and groundbreaking research, the book reveals how cognitive biases shape our decisions, offering insights into judgment, risk, and the ways we think about the world.", PublicationYear = 2011, AvailableCopies = 10, TotalCopies = 15, CategoryId = 3 },
                new Book { Id = 18, Title = "The Power of Habit", ImageUrl = "Uploads/Books/c70e070d-1a1f-499c-9b66-9373873efd4d_20250330_001755.png", AuthorId = 18, Description = "Charles Duhigg's 'The Power of Habit' uncovers the science behind why habits form and how they can be changed. Drawing on research and real-life stories, the book explains the habit loop and provides strategies for transforming routines, empowering readers to make positive changes in their personal and professional lives.", PublicationYear = 2012, AvailableCopies = 9, TotalCopies = 14, CategoryId = 3 },
                new Book { Id = 19, Title = "Atomic Habits", ImageUrl = "Uploads/Books/cdb6b6a0-dfc6-4f79-b81f-d53cbd47f797_20250329_234920.jpeg", AuthorId = 19, Description = "James Clear's 'Atomic Habits' offers a practical guide to building good habits and breaking bad ones through small, incremental changes. The book combines scientific research with actionable advice, showing how tiny adjustments can lead to remarkable results in productivity, health, and overall well-being.", PublicationYear = 2018, AvailableCopies = 10, TotalCopies = 15, CategoryId = 3 },
                new Book { Id = 20, Title = "The 7 Habits of Highly Effective People", ImageUrl = "Uploads/Books/2d209324-e47a-4a72-b249-c27a8fd9b447_20250330_000600.jpeg", AuthorId = 20, Description = "Stephen R. Covey's influential book presents a holistic approach to personal and professional effectiveness. Through seven core habits, Covey guides readers toward greater self-awareness, proactive behavior, and meaningful relationships, offering timeless principles for achieving lasting success and fulfillment in all areas of life.", PublicationYear = 1989, AvailableCopies = 14, TotalCopies = 20, CategoryId = 3 },
